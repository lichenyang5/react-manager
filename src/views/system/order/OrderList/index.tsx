...
export default function OrderList() {
  ...
  const orderRef = useRef<{ open: () => void }>(null)
  const detailRef = useRef<{ open: (orderId: string) => void }>(undefined)
  const markerRef = useRef<{ open: (orderId: string) => void }>(undefined)
  const routeRef = useRef<{ open: (orderId: string) => void }>(undefined)
  const getTableData = (
        ...
        return (
          <Space>
            ...
            <Button
              type='text'
              danger
              onClick={() => handleDel(record.orderId)}
            >
              删除
            </Button>
          </Space>
